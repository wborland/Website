...
def addHeaders(response):
	response.headers['Content-Security-Policy'] = "Content-Security-Policy: cookie-scope host default-src https 'self';object-src 'self' https://cdnjs.cloudflare.com https://maxcdn.bootstrapcdn.com https://cdn.datatables.net https://ajax.googleapis.com; "
